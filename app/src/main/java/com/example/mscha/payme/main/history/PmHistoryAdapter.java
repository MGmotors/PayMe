...
import com.example.mscha.payme.main.history.HistoryFragment.OnListFragmentInteractionListener;
...
public class PmHistoryAdapter extends RecyclerView.Adapter<PmHistoryAdapter.ViewHolder> {
    ...
    public PmHistoryAdapter(List<HistoryItem> historyItems, OnListFragmentInteractionListener listener) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.titleTV.setText(holder.historyItem.title);
